                ...
                <div class="col-sm-6">
                    ...
                    <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="designation" placeholder="designation / position"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="level_of_position" placeholder="level of position"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Mode of Accession</label>
                            <input type="text" name="mode_of_accession" placeholder="mode of accession"
                                class="form-control">
                        </div>
                        <div class="form-group">
